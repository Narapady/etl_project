...
class FoodAvailablity:
    ...
    def process_calories(self):
        ...
        for sheet in range(1,3):
            ...
            key = os.path.join(self.new_dir, f"{sheetnames[sheet].lower()}.csv")
    ...
    def process_foodgroups(self):
        ...
        for path in file_paths:
            ...
            sheet_names = self.s3.get_sheetnames(self.src_bucket, os.path.join(self.dirname, path))[1:]
            ...
            for name in sheet_names:
                ...
                df = self.s3.load_df(self.src_bucket, os.path.join(self.dirname, path), "xls", name)
                # use title as key 
